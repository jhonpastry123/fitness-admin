    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Διαχείριση Μενού</h1>
            </div>
        </div>
    </div>
    <!-- END Hero -->
            ...
            <div class="block-header block-header-default">
                ...
                <div class="block-options">
                    <div class="pull-right">
                        <a class="btn btn-primary" href="{{ route('categories.create') }}" data-toggle="tooltip" title="Δημιουργία">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('categories.destroy',$category->id) }}" method="POST">
                                        <div class="btn-group">
                                            <a class="btn btn-success" href="{{ route('categories.show',$category->id) }}" data-toggle="tooltip" title="Επισκόποηση">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a class="btn btn-primary" href="{{ route('categories.edit',$category->id) }}"  data-toggle="tooltip" title="Επεξεργασία">
